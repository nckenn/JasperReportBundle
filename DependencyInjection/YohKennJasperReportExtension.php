...
namespace YohKenn\JasperReportBundle\DependencyInjection;
 ...
 */
class YohKennJasperReportExtension extends Extension
{
    /**
     * {@inheritdoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $reportClientDefinition = $container->getDefinition('yohkenn.jasper.report.client');
